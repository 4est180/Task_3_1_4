...
on(document, 'click', '#edit-user', e => {
    ...
    document.getElementById('age2').value = userInfo.children[2].innerHTML
    document.getElementById('name2').value = userInfo.children[3].innerHTML
    document.getElementById('lastName2').value = userInfo.children[4].innerHTML
...
on(document, 'click', '#delete-user', e => {
    ...
    document.getElementById('age3').value = fila2.children[2].innerHTML
    document.getElementById('name3').value = fila2.children[3].innerHTML
    document.getElementById('lastName3').value = fila2.children[4].innerHTML
